...
class TestAsyncContact(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_all_todos(self):
        limit = 10
        offset = 0
        contacts = [Contact(id=1, first_name='test_title_1', additional_data='test_description_1', user=self.user),
                    Contact(id=2, first_name='test_title_2', additional_data='test_description_2', user=self.user)]
